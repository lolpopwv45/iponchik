...
export const PRODUCTS: Product[] = [
  ...
  product({
    ...
    categoryId: 1,
    category: 'Пиццы',
    image: '/images/product-pizza-pepperoni.webp',
    badges: ['spicy'],
  ...
  product({
    ...
    categoryId: 2,
    category: 'Пирожки',
    image: '/images/product-pirozhok.webp',
    badges: [],
  ...
  product({
    ...
    categoryId: 3,
    category: 'Десерты',
    image: '/images/product-donut-classic.webp',
    badges: ['meatless'],
  ...
  product({
    ...
    categoryId: 3,
    category: 'Десерты',
    image: '/images/product-donut-chocolate.webp',
    badges: ['meatless', 'new'],
  ...
  product({
    ...
    categoryId: 3,
    category: 'Десерты',
    image: '/images/product-cinnamon-roll.webp',
    badges: ['meatless', 'new'],
